...
public class StreamMerge {
    public static void main(String[] args) throws Exception {
        ...
        unionStreamUsage(env);

        connectStreamWithCoMapUsage(env);

        connectStreamWithCoProcessUsage(env);

        env.execute();
    }

    public static void unionStreamUsage(StreamExecutionEnvironment env){
        // Union合流
    ...
    public static void connectStreamWithCoMapUsage(StreamExecutionEnvironment env) {
        // Connect 合流
    ...
    public static void connectStreamWithCoProcessUsage(StreamExecutionEnvironment env) {
    ...
    static class MyKeyedConnectCoProcessFunction
            extends CoProcessFunction<Tuple2<Integer, String>, Tuple3<Integer, String, Integer>, String> {
