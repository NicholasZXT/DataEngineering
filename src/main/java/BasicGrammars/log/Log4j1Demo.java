...
public class Log4j1Demo {
    public static void main(String[] args) {
        Log4j1Demo logDemo = new Log4j1Demo();
    ...
    static Logger logger = LogManager.getLogger(Log4j1Demo.class.getSimpleName());
    ...
    public void log4jLogging(){
        System.out.println(Log4j1Demo.class.getName());
        System.out.println(Log4j1Demo.class.getSimpleName());
        ...
        // 字符串占位符
        // 默认支持使用 {} 作为占位符
        logger.info("Info message for {}.", Log4j1Demo.class.getSimpleName());
        // 使用 String.format 的方式需要使用 LogManager.getFormatterLogger() 方法 —— 不过此时就不能使用上面的 {} 方式了
        logger.info("Info message for %s.", Log4j1Demo.class.getSimpleName());
